...
class TransferToStrativaAccountSubscreen extends StatefulWidget {
 ...
 @override
  State<TransferToStrativaAccountSubscreen> createState() => _TransferToAccountSubscreenState();
}
...
class _TransferToAccountSubscreenState extends State<TransferToStrativaAccountSubscreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('Transfer to strativa account', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w500)),
        elevation: 0,
