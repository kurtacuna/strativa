...
class CheckIfOtherAccountExistsViewTest(APITestCase):
    def setUp(self):
        ...
        strativa_bank = my_accounts_models.StrativaBanks.objects.create(
            bank_name="Strativa"
        )
        ...
        other_bank1 = models.OtherBanks.objects.create(bank_name="Banco de Oro1")
        other_bank2 = models.OtherBanks.objects.create(bank_name="Banco de Oro2")
        other_bank3 = models.OtherBanks.objects.create(bank_name="Banco de Oro3")
        other_bank4 = models.OtherBanks.objects.create(bank_name="Banco de Oro4")
        other_bank5 = models.OtherBanks.objects.create(bank_name="Banco de Oro5")
