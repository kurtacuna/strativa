...
class UserData(models.Model):
  ...
  phone_number = models.CharField(max_length=765)
  address = models.CharField(max_length=765)
  id_image = models.ImageField(upload_to='id_images/', default='images/logo.png')
  Selfie_image = models.ImageField(upload_to='selfie_images/', default='images/logo.png')
